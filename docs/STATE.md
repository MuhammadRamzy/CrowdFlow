...
**Tree status:** green — 310 Rust, 65 web and 38 Python tests passing, 4 ignored
...
The engine is in good shape. **310 Rust, 65 web, 38 Python tests; 4 ignored** — and one of those
